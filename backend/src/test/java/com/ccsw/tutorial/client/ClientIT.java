...
public class ClientIT {
    ...
    public static final Long NEW_CLIENT_ID = 100L;
    public static final String NEW_CLIENT_NAME = "CL1";
    ...
    public void modifyWithExistIdShouldModifyClient() {
        ...
        ClientDto clientSearch = response.getBody().stream().filter(item -> item.getId().equals(MODIFY_CATEGORY_ID))
                .findFirst().orElse(null);
